...
class LINGUPlacesPage extends StatefulWidget {
  @override
  State createState() => new LINGUPlacestate();
}

class LINGUPlacestate extends State<LINGUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_lingu().then((data) {
        this.setState(() {
          _places = data;
        });
      });
