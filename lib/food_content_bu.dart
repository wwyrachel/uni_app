...
class BUPlacesPage extends StatefulWidget {
  @override
  State createState() => new BUPlacestate();
}

class BUPlacestate extends State<BUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_bu().then((data) {
        this.setState(() {
          _places = data;
        });
      });
