...
class SYUPlacesPage extends StatefulWidget {
  @override
  State createState() => new SYUPlacestate();
}

class SYUPlacestate extends State<SYUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_syu().then((data) {
        this.setState(() {
          _places = data;
        });
      });
