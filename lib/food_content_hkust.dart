...
class HKUSTUPlacesPage extends StatefulWidget {
  @override
  State createState() => new HKUSTUPlacestate();
}

class HKUSTUPlacestate extends State<HKUSTUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_hkust().then((data) {
        this.setState(() {
          _places = data;
        });
      });
