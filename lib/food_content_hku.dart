...
class HKUPlacesPage extends StatefulWidget {
  @override
  State createState() => new HKUPlacestate();
}

class HKUPlacestate extends State<HKUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_hku().then((data) {
        this.setState(() {
          _places = data;
        });
      });
