...
class CUPlacesPage extends StatefulWidget {
  @override
  State createState() => new CUPlacestate();
}

class CUPlacestate extends State<CUPlacesPage> {
  ...
  void initState() {
    super.initState();
    if (_places == null) {
      LocationService.get().getNearbyPlaces_cu().then((data) {
        this.setState(() {
          _places = data;
        });
      });
